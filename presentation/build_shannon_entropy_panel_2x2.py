...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Build a Shannon-entropy 2x2 panel directly from behavior_results_rows.csv with "
    ...
    parser.add_argument(
        "--out",
        default="presentation/testing/overleaf_images/shannon_entropy/shannon_entropy_panel_2x2.png",
...
def load_run_rows(
    ...
    rows = base.aggregate_dataset_means(run_dir / "behavior_results_rows.csv", y_metric=base.METRIC_ENTROPY)
...
def plot_single_axis(
    ...
    ax.set_ylabel("Shannon entropy", fontsize=AXIS_LABEL_FONTSIZE)
...
def main() -> int:
    ...
    fig.suptitle("Similarity vs Shannon entropy", fontsize=30, fontweight="bold", y=0.985)
